...
> el puerto 8032 (pasa al reiniciar el PC: la API vieja revive sin su
...
> ```
> NAMES                                                 STATUS                    PORTS
> proyecto_aplicacion_y_servicios_web1-api-facturas-1   Up 2 hours                0.0.0.0:8032->8032/tcp
> proyecto_aplicacion_y_servicios_web1-sqlserver-1      Up 2 hours (healthy)      0.0.0.0:11463->1433/tcp
> ```
>
...
| [Pruebas y calidad de las pruebas](docs/PRUEBAS_Y_CALIDAD_DE_PRUEBAS.md) | Qué es una prueba, cómo se escribe una que sirva, los tipos y el doble de prueba. Y al final: cobertura, la métrica CRAP y *mutation testing* — cómo saber si sus pruebas de verdad protegen |
